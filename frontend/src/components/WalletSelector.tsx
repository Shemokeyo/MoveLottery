  ...
  function WalletRow({ wallet, onConnect }: WalletRowProps) {
    return (
      <WalletItem
        wallet={wallet}
        onConnect={onConnect}
        className="flex items-center justify-between px-4 py-3 gap-4 border rounded-md font-primary"
      >
        ...
        {isInstallRequired(wallet) ? (
          ...
          <WalletItem.ConnectButton asChild>
            <Button size="sm" className="bg-[#e5ffad] hover:bg-[#e5ffad]/90  text-black rounded-full">
              Connect
            </Button>
